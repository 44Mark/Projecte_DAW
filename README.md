...
## 1. Introducció
Aquest projecte té com a objectiu desenvolupar un sistema de gestió de reserves d'aules per al professorat de la intranet del centre de l'institut Sa Palomera. El sistema permetrà als professors reservar una aula durant un temps determinat. Aquest sistema facilitarà l'organització de les aules, millorarà l'eficiència en l'assignació de recursos i ajudarà a evitar conflictes d'horaris amb el professorat.
...
<img src="public/Images/Diagrama_Casosdus.jpg" alt="Diagrama de Casos d'Ús" width="700"/>
...
<img src="public/Images/Diagrama_Activitats.jpg" alt="Diagrama d'Activitats" width="500"/>
